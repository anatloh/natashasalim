...
* **Key Achievements:**
  ...
  * Engineered custom REST API data flows connecting storefronts to central servers, improving reporting accuracy by **98%**.
  * Optimized server deployment configurations, reducing setup time for 15+ new store openings by **40%**.
* **Tech Stack:** `Azure` `Python` `REST APIs` `SQL` `JSON` `IIS/Nginx`
...
* **Key Achievements:**
  ...
  * Implemented structured relational storage schema in **SQLite3** for high-integrity data retention.
  * Designed an interactive UI dashboard using **Streamlit** to visualize trend metrics in real time.
* **Tech Stack:** `Python` `Pandas` `SQLite3` `Streamlit`
...
* **Key Achievements:**
  ...
  * Coordinated deployment of 50+ enterprise software updates in high-demand production environments.
* **Tech Stack:** `ERP Support` `SQL Auditing` `System Logging` `Linux`
...
| :--- | :--- | :--- |
| **Cloud & DevOps** | Azure Fundamentals (AZ-900) | Microsoft |
| **Programming** | Python Professional Level | TQC |
| **Programming** | Python Essentials 1 | Cisco Networking Academy |
| **Development** | Software Engineer & REST API (Intermediate) | HackerRank |
| **Development** | Foundational C# | freeCodeCamp / Microsoft |
| **Networking** | Networking Basics & IT Customer Support | Cisco |
